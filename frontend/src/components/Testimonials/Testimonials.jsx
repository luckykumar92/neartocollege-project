...
import { InfiniteMovingCards } from "../ui/custom/infinite-moving-cards";
...
const Testimonials = () => {
  return (
    <div className="py-10 flex flex-col antialiased bg-[#023047] bg-opacity-95 dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
